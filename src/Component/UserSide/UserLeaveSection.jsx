...
function UserLeaveSection() {
    ...
    return (
        <div className="bg-blue-50 p-10">
            ...
            <div className=" bg-white p-4 pl-6 flex justify-between items-center mb-6 rounded-lg">Dashboard>Apply for Leave </div>
            ...
            <div className=" bg-white p-4 pl-6  mb-6 rounded-lg">
                ...
                <div className="grid grid-cols-2  lg:grid-cols-4 gap-4 mb-6">
                    <div className="bg-blue-900 flex items-center gap-2 rounded-xl p-4">
                        <div className="bg-white h-24 w-24 rounded-full text-6xl flex justify-center items-center">60</div>
                    ...
                    <div className="bg-blue-900 flex items-center gap-2 rounded-xl p-4">
                        <div className="bg-white h-24 w-24 rounded-full text-6xl flex justify-center items-center">20</div>
                        <div className="ml-6 text-center">
                            <h2 className="text-white text-xl font-semibold">Sick Leave</h2>
                            <button
                                onClick={() => setActiveTab("leaveSettings")}
                                className={` px-6   transition-colors ${activeTab === "leaveSettings"
                                    ? "bg-yellow-500 text-white rounded-3xl p-1 w-36"
                                    : "bg-yellow-500 text-white rounded-3xl p-1 w-36"
                                    }`}
                            >
                    ...
                    <div className="bg-blue-900 flex items-center gap-2 rounded-xl p-4">
                        ...
                        <div className="ml-6 text-center">
                            ...
                            <button
                                ...
                                className={` px-6   transition-colors ${activeTab === "leaveRecall"
                                    ? "bg-yellow-500 text-white rounded-3xl p-1 w-36"
                                    : "bg-yellow-500 text-white rounded-3xl p-1 w-36"
                                    }`}
                            >
                    ...
                    <div className="bg-blue-900 flex items-center gap-2 rounded-xl p-4">
                        ...
                        <div className="ml-6 text-center">
                            ...
                            <button
                                onClick={() => setActiveTab("reliefOfficers")}
                                className={` px-6   transition-colors ${activeTab === "reliefOfficers"
                                    ? "bg-yellow-500 text-white rounded-3xl p-1 w-36"
                                    : "bg-yellow-500 text-white rounded-3xl p-1 w-36"
                                    }`}
                            >
                                    ...
                                    <div className="flex justify-between items-center ">
                                        <div className="mb-6">
                                            ...
                                            <select className="shadow appearance-none text-sm rounded w-full py-3 px-8 text-gray-700 bg-blue-50 leading-tight outline-none ">
                                                <option value="">Select option from dropdown</option>
                                                <option value="">
                                                    Select option from dropdown 2
                                                </option>
                                                <option value="">
                                                    Select option from dropdown 3
                                                </option>
                                            </select>
                                        </div>
                                        <div className="mb-8">
